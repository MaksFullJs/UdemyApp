  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          url = type === 'password' ? 'http://localhost:5050/api/users/updatePassword' : 'http://localhost:5050/api/users/updateMe';
          console.log(data);
          _context.n = 1;
          return (0, _axios.default)({
            method: 'PATCH',
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var session, stripe, _err$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          ...
          _context.n = 1;
          return (0, _axios.default)("http://localhost:5050/api/bookings/checkout-session/".concat(tourId));
        case 1:
          session = _context.v;
          ...
          _context.n = 2;
          return Stripe('pk_test_51RlAP8IZwJC3270FA2mEIlyIjaMdRwkzYYap0uYv92qkO0yCsdQKFQfBXRAE3V2WkeQEMNtoIK0UGyXRbOzVnWAB003c5Af9jk');
        case 2:
          stripe = _context.v;
        ...
        case 4:
          _context.p = 4;
          _t = _context.v;
          console.error('Full error:', _t);
          (0, _alert.showAlert)('error', ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || 'Помилка оплати');
        case 5:
          return _context.a(2);
      }
    }, _callee, null, [[0, 4]]);
